# -*- coding: utf-8 -*-
"""
Created on Wed Apr  3 10:53:39 2019
...
psd2 = multi_power('head_movement\\190131\\base_opened_raw.fif', tmin=60, tmax=120, 
             fmin_list=[290, 305.5, 313, 319.5], fmax_list=[294, 308.5, 315, 322.5])
base_opened = correlation(psd1, psd2)
print(base_opened)
...
psd1 = multi_power('head_movement\\190131\\base_hand_raw.fif', tmin=0, tmax=60, 
             fmin_list=[290, 305.5, 313, 319.5], fmax_list=[294, 308.5, 315, 322.5])
psd2 = multi_power('head_movement\\190131\\base_hand_raw.fif', tmin=60, tmax=120,
             fmin_list=[290, 305.5, 313, 319.5], fmax_list=[294, 308.5, 315, 322.5])
base_hand = correlation(psd1, psd2)
print(base_hand)