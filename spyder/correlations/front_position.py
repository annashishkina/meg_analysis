# -*- coding: utf-8 -*-
"""
Created on Wed Apr  3 11:18:02 2019
...
#------------------------------------------------------------------------------
# Correlation between two psd vectors (first and second half of front_opened condition)
#------------------------------------------------------------------------------
psd1 = multi_power('head_movement\\190131\\front_opened_raw.fif', tmin=0, tmax=60, 
...
psd2 = multi_power('head_movement\\190131\\front_opened_raw.fif', tmin=60, tmax=120, 
             fmin_list=[290, 305.5, 313, 319.5], fmax_list=[294, 308.5, 315, 322.5])
front_opened = correlation(psd1, psd2)
print(front_opened)
...
#------------------------------------------------------------------------------
# Correlation between two psd vectors (first and second half of front_hand condition)
#------------------------------------------------------------------------------
psd1 = multi_power('head_movement\\190131\\front_hand_raw.fif', tmin=0, tmax=60, 
             fmin_list=[290, 305.5, 313, 319.5], fmax_list=[294, 308.5, 315, 322.5])
psd2 = multi_power('head_movement\\190131\\front_hand_raw.fif', tmin=60, tmax=120,
             fmin_list=[290, 305.5, 313, 319.5], fmax_list=[294, 308.5, 315, 322.5])
front_hand = correlation(psd1, psd2)
print(front_hand)
